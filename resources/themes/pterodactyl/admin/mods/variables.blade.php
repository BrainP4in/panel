...
@section('title')
    Mod &rarr; {{ $mod->name }} &rarr; Variables
@endsection

@section('content-header')
    <h1>{{ $mod->name }}<small>Managing variables for this Mod.</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">Admin</a></li>
        <li><a href="{{ route('admin.nests') }}">NestModss</a></li>
        <li><a href="{{ route('admin.nests.egg.view', $mod->id) }}">{{ $mod->name }}</a></li>
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                <li><a href="{{ route('admin.mods.view', $mod->id) }}">Configuration</a></li>
                <li class="active"><a href="{{ route('admin.mods.variables', $mod->id) }}">Variables</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="row">
    @foreach($mod->mod_variable as $variable)
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ $variable->name }}</h3>
                </div>
                <form action="{{ route('admin.mods.variables.edit', ['id' => $mod->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">Input type <span class="field-required"></span></label>
                            <input type="text" name="input_type" class="form-control" value="{{ $variable->input_type }}" placeholder="TEXT,STEAMWORKSHOP,..." />
                            <p class="text-muted small">This option is used to access other form types, like a Mod-picker.</p>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="newVariableModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.mods.variables', $mod->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">Input type <span class="field-required"></span></label>
                        <input type="text" name="input_type" class="form-control" value="TEXT" placeholder="TEXT,STEAMWORKSHOP,..." />
                        <p class="text-muted small">This option is used to access other form types, like a Mod-picker.</p>
                    </div>
                    <div class="form-group">
