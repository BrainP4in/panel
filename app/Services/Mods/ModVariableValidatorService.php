...
class ModVariableValidatorService
{
    use HasUserLevels;
    ...
    public function __construct(
        ModVariableRepositoryInterface $optionVariableRepository,
     ...
     */
    public function handle(int $mod, array $fields = []): Collection
    {
        $variables = $this->optionVariableRepository->findWhere([['mod_id', '=', $mod]]);
